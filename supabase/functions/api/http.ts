...
export async function handleRequest(req: Request) {
  ...
  try {
    ...
    switch (action) {
      ...
      case "bank_rule_enable": return json(await enableBankRule(user, body.id, body.enabled, body.expectedVersion, body.activationToken));
      ...
      case "bank_rule_dry_run": return json(await dryRunBankRules(user, body.draft, body.expectedVersion));
