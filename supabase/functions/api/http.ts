...
export async function handleRequest(req: Request) {
  ...
  try {
    ...
    switch (action) {
      ...
      case "apply_bank_rules": return json(await applyBankRules(user));
      case "ignore_bank_transaction": return json(await ignoreBankTransaction(user, body.id, body.ignored));
